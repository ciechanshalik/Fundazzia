...
const uiText = {
  pl: {
    ...
    courseFormLead: "Zostaw kontakt, wybierz kurs i napisz klasę lub wiek. Odezwę się z informacją o grupach, terminach i najbliższych miejscach.",
    courseFormParentName: "Imię i nazwisko rodzica",
    courseFormEmail: "Email",
    courseFormPhone: "Nr telefonu",
    courseFormChildAge: "Klasa/wiek",
  ...
  en: {
    ...
    courseFormLead: "Leave your contact details, choose a course and add the grade or age. We will get back to you with groups, dates and available places.",
    courseFormParentName: "Parent or guardian name",
    courseFormEmail: "Email",
    courseFormPhone: "Phone number",
    courseFormChildAge: "Grade/age",
  ...
  de: {
    ...
    courseFormLead: "Hinterlasse Kontakt, wähle einen Kurs und gib Klasse oder Alter an. Wir melden uns mit Gruppen, Terminen und freien Plätzen.",
    courseFormParentName: "Name des Elternteils",
    courseFormEmail: "E-Mail",
    courseFormPhone: "Telefonnummer",
    courseFormChildAge: "Klasse/Alter",
